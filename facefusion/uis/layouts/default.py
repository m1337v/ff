...
def run(ui : gradio.Blocks) -> None:
	...
	ui.queue(concurrency_count = concurrency_count).launch(show_api = True, quiet = True, server_name="0.0.0.0", server_port=7860, share=True, inbrowser = facefusion.globals.open_browser)
